/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b7f9956a76b6e620dcb59fb1c344b55f)
// Runtime types generated with workerd@1.20260107.1 2026-01-11 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/index");
	}
	interface Env {
		ALLOWED_ORIGINS: "https://soumil4561.github.io" | "http://localhost:3000";
		LOG_LEVEL: "debug";
		PORT: string;
		NODE_ENV: string;
		BREVO_HOST: string;
		...
		TURNSTILE_SITEVERIFY_HOST: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "LOG_LEVEL" | "PORT" | "NODE_ENV" | "BREVO_HOST" | "BREVO_API_KEY" | "SENDER_EMAIL" | "SENDER_NAME" | "RECIPIENT_EMAIL" | "RECIPIENT_NAME" | "TURNSTILE_SITEVERIFY_HOST" | "TURNSTILE_SECRET_KEY">> {}
}
